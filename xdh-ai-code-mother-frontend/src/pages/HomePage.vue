<template>
  <div class="home-page">
    <section class="hero-section">
      <div class="hero-section__glow hero-section__glow--left"></div>
      <div class="hero-section__glow hero-section__glow--right"></div>

      <div class="hero-section__content">
        <div class="hero-section__brand">
          <img alt="一句话生所想" class="hero-section__logo" src="@/assets/logo.png" />
          <span class="hero-section__brand-text">一句话生所想</span>
        </div>

        <h1 class="hero-section__title">与 AI 对话，快速创建应用和网站</h1>
        <p class="hero-section__subtitle">
          输入一句需求，系统会自动创建应用、进入对话并实时生成网页效果。
        </p>
        ...
        <div class="hero-section__composer">
          ...
          <div class="hero-section__composer-footer">
            <div class="hero-section__tips">
              <a-tag color="processing">支持中文自然语言</a-tag>
              <a-tag color="default">自动跳转到应用对话页</a-tag>
            </div>
...
import { APP_PAGE_SIZE, getAppIdString, resolveAppDeployUrl } from '@/utils/app'
...
.hero-section {
  ...
  border-radius: 40px;
  background:
    radial-gradient(circle at top, rgba(255, 255, 255, 0.92), rgba(255, 255, 255, 0.78)),
    linear-gradient(135deg, rgba(118, 255, 228, 0.22), rgba(90, 152, 255, 0.22));
...
.hero-section__glow--left {
  top: -48px;
  left: -60px;
  background: rgba(125, 255, 233, 0.8);
}

.hero-section__glow--right {
  right: -80px;
  bottom: -80px;
  background: rgba(121, 160, 255, 0.7);
}
